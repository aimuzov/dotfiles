...
- **SketchyBar** - Визуальная обратная связь через сигнал `window_focus`, который элементы ставят себе сами, а не берут из `yabairc` (см. [sketchybar](../sketchybar/README.ru.md))
