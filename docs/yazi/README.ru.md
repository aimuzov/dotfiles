...
- Конфигурирует плагин `border` для пользовательских границ окон.
- Простая инициализация: `require("border"):setup()`
- Используется стандартный statusline Yazi (плагин yatline был удалён).
