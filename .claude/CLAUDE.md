...
- `chezmoi apply` - требует пароль KeePassXC для обработки шаблонов
- `chezmoi status` - требует пароль KeePassXC для обработки шаблонов
- `chezmoi diff` - требует пароль KeePassXC для обработки шаблонов
