			...
			highlight_overrides = {
				all = function(c)
					return {
						...
						BufferLineCloseButtonVisible = { link = "BufferLineCloseButtonSelected" },
						BufferLineDevIconLuaInactive = { link = "BufferLineDevIconLuaSelected" },
						BufferLineDevIconLuaVisible = { link = "BufferLineDevIconLuaSelected" },
						BufferLineDiagnosticVisible = { link = "BufferLineDiagnosticSelected" },
						BufferLineDuplicateVisible = { link = "BufferLineDuplicateSelected" },
						BufferLineErrorDiagnosticVisible = { link = "BufferLineErrorDiagnosticSelected" },
						BufferLineErrorVisible = { link = "BufferLineErrorSelected" },
						BufferLineFill = { bg = c.mantle },
						BufferLineHintDiagnosticVisible = { link = "BufferLineHintDiagnosticSelected" },
						BufferLineHintVisible = { link = "BufferLineHintSelected" },
						BufferLineIndicatorVisible = { link = "BufferLineIndicatorSelected" },
						BufferLineInfoDiagnosticVisible = { link = "BufferLineInfoDiagnosticSelected" },
						BufferLineInfoVisible = { link = "BufferLineInfoSelected" },
						BufferLineModifiedVisible = { link = "BufferLineModifiedSelected" },
						BufferLineNumbersVisible = { link = "BufferLineNumbersSelected" },
						BufferLinePick = { bg = c.mantle },
						BufferLinePickVisible = { link = "BufferLinePickSelected" },
						BufferLineSeparator = { bg = c.mantle, fg = c.base },
						...
						BufferLineVisible = { link = "BufferLineSeparatorSelected" },
						BufferLineWarningDiagnosticVisible = { link = "BufferLineWarningDiagnosticSelected" },
						BufferLineWarningVisible = { link = "BufferLineWarningSelected" },
